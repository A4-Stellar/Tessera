...
export function VersionBanner({
  ...
  return (
    <div role="status" aria-live="polite" className="bg-brand-900/30 border-l-4 border-brand-400 px-4 py-3 mb-6">
      <p className="text-sm text-brand-200">
        <span aria-hidden="true">📋 </span><strong>API Version:</strong> These docs apply to <code className="bg-black/30 px-2 py-1 rounded text-xs">{docsVersion}</code>.
